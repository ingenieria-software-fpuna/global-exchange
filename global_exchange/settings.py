...
EMAIL_HOST = 'smtp.gmail.com'  # O 'smtp.mailgun.org', etc.
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'ca.sebastianlv@fpuna.edu.py'
EMAIL_HOST_PASSWORD = 'qcsq abwj aqid vxfm'
DEFAULT_FROM_EMAIL = 'ca.sebastianlv@fpuna.edu.py'