...
urlpatterns = [
    ...
    path('pago-billetera-electronica/<str:transaccion_id>/', views.pago_billetera_electronica, name='pago_billetera_electronica'),
    path('pago-tarjeta-debito/<str:transaccion_id>/', views.pago_tarjeta_debito, name='pago_tarjeta_debito'),
    path('pago-transferencia-bancaria/<str:transaccion_id>/', views.pago_transferencia_bancaria, name='pago_transferencia_bancaria'),
